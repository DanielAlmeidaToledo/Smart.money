    ...
    <div className={cn('__login-container', className)}>
        ...
        <div className={cn('__login-content')}>
            ...
            <div className={cn('__login-logo')}>
                ...
                <h3>Controle suas finanças com eficiência através da <span>Smart.money</span></h3>
            </div>
            {/* Formulário*/}
            <div className={cn('__login-form')}>
              <form action="">
                ...
                {/* Botão Enviar */}
                <button className={cn('__login-form-button')}>Entrar</button>
              </form>
              <p className={cn('__login-cadastro')}>Ainda não possui conta? <a href='/registro'>Faça o cadastro!</a></p>
            </div>
        </div>
    </div>
  );
